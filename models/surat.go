...
type Surat struct {
	...
	NomorSurat  string    `gorm:"type:varchar(50)" json:"nomor_surat"`
	...
	TanggalSelesai     *time.Time `gorm:"type:timestamp null" json:"tanggal_selesai"`
	...
	IsSLAWarningSent   bool       `gorm:"default:false" json:"is_sla_warning_sent"`
